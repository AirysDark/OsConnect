...
# See https://github.com/TigerVNC/OsConnect/issues/8, also bug #1208814
BuildRequires:  fltk-devel >= 1.3.3
BuildRequires:  xorg-x11-server-devel

Requires:       hicolor-icon-theme
Requires:       OsConnect-license
Requires:       OsConnect-icons
...
Requires:       OsConnect-server-minimal = %{version}-%{release}
...
Requires:       OsConnect-license, dbus-x11
...
%files server
%config(noreplace) %{_sysconfdir}/pam.d/OsConnect
%config(noreplace) %{_sysconfdir}/OsConnect/vncserver-config-defaults
%config(noreplace) %{_sysconfdir}/OsConnect/vncserver-config-mandatory
%config(noreplace) %{_sysconfdir}/OsConnect/vncserver.users
...
- Resolves: bz#1248422
  CVE-2014-8240 CVE-2014-8241 OsConnect: various flaws
...
- Use keyboard input code from OsConnect-1.3.0 (bug #1053536).
...
- OsConnect-setcursor-crash.patch: Attempt to paper over a crash in Xvnc when
  setting the cursor.
...
- OsConnect12-xorg113-glx.patch: Fix to only init glx on the first server
  generation

* Fri Sep 28 2012 Adam Jackson <ajax@redhat.com> 1.2.80-0.2.20120905svn4996
- OsConnect12-xorg113-glx.patch: Re-enable GLX against xserver 1.13

* Fri Aug 17 2012 Adam Tkac <atkac redhat com> 1.2.80-0.1.20120905svn4996
- update to 1.2.80
- remove deprecated patches
  - OsConnect-102434.patch
  - OsConnect-viewer-reparent.patch
  - OsConnect11-java7.patch
- patches merged
  - OsConnect11-xorg111.patch
  - OsConnect11-xorg112.patch
...
- patches merged
  - OsConnect11-glx.patch
  - OsConnect11-CVE-2011-1775.patch
...
- update to r4237
- patches merged
  - OsConnect11-optionsdialog.patch
  - OsConnect11-rh607866.patch
...
- update to r4225
- patches merged
  - OsConnect11-rh611677.patch
  - OsConnect11-rh633931.patch
  - OsConnect11-xorg1.10.patch
...
- update to r4113
- patches merged
  - OsConnect11-rh586406.patch
  - OsConnect11-libvnc.patch
  - OsConnect11-rh597172.patch
  - OsConnect11-rh600070.patch
  - OsConnect11-options.patch
...
- patches merged to upstream
  - OsConnect11-rh522369.patch
  - OsConnect11-rh551262.patch
  - OsConnect11-r4002.patch
  - OsConnect11-r4014.patch
...
- update to r3993 1.0.90 snapshot
  - OsConnect11-noexecstack.patch merged
  - OsConnect11-xorg18.patch merged
...
- drop OsConnect-xorg25909.patch, it has been merged to X.Org upstream
...
- patches merged
  - OsConnect10-compat.patch
  - OsConnect10-rh510185.patch
  - OsConnect10-rh524340.patch
  - OsConnect10-rh516274.patch
...
- update to 1.0.0
- OsConnect10-rh495457.patch merged to upstream
...
- don't ship OsConnect-server-module on s390/s390x
...
- patches merged
  - OsConnect10-rh499401.patch
  - OsConnect10-rh497592.patch
  - OsConnect10-rh501832.patch
- after discusion in upstream drop OsConnect-bounds.patch
...
- remove merged OsConnect-manminor.patch
...
- update to r3789
  - OsConnect-rh494801.patch merged
- OsConnect-newfbsize.patch is no longer needed
...
- update to r3751
- patches merged
  - OsConnect-xclients.patch
  - OsConnect-clipboard.patch
  - OsConnect-rh212985.patch
