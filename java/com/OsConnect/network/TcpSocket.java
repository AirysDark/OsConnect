...
package com.OsConnect.network;

import com.OsConnect.rdr.FdInStream;
import com.OsConnect.rdr.FdOutStream;
import com.OsConnect.rdr.Exception;
import com.OsConnect.rfb.LogWriter;
...
public class TcpSocket extends Socket {
  ...
  public static boolean isSocket(java.net.Socket sock) {
    return sock.getClass().toString().equals("com.OsConnect.net.Socket");
  }
