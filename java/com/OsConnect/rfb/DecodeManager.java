...
import static com.OsConnect.rfb.Decoder.DecoderFlags.*;
...
public class DecodeManager {
  ...
  private class DecodeThread implements Runnable {
    ...
    public void run()
    {
      ...
      while (!stopRequested) {
        ...
        } catch (com.OsConnect.rdr.Exception e) {
  ...
  private com.OsConnect.rdr.Exception threadException;
