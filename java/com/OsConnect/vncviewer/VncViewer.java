...
package com.OsConnect.vncviewer;
...
import com.OsConnect.rdr.*;
import com.OsConnect.rfb.*;
import com.OsConnect.network.*;

import static com.OsConnect.vncviewer.Parameters.*;
...
public class VncViewer implements Runnable {
  ...
  static ImageIcon frameIconSrc =
    new ImageIcon(VncViewer.class.getResource("OsConnect.ico"));
  public static final Image frameIcon = frameIconSrc.getImage();
  public static final ImageIcon logoIcon =
    new ImageIcon(VncViewer.class.getResource("OsConnect.png"));
  ...
  public VncViewer(String[] argv) {
    ...
    } catch (com.OsConnect.rfb.Exception e) {
      defaultServerName = "";
  ...
  public static void usage() {
    String usage = ("\nusage: vncviewer [options/parameters] "+
                    ...
                    "[options/parameters]\n"+
                    "       vncviewer [options/parameters] [.OsConnect file]\n"+
                    "\n"+
                    "Options:\n"+
